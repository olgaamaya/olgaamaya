...
// Function to fetch media from the backend in a batch request
    ...
    fetch(`https://new-vhym.onrender.com/api/get-cloudinary-media?folders=${folderNames.join(',')}`)
        ...
        .then(data => {
            ...
            data.forEach(media => {
                ...
                // Capitalize the first letter to match the ID in the HTML
                const lightboxId = folderName.charAt(0).toUpperCase() + folderName.slice(1);

                // Select the corresponding lightbox by ID (note: capitalized first letter)
                ...
                if (lightbox) {
                    ...
                    // Add the media to a new slide div inside the lightbox
                    const slide = document.createElement('div');
                    slide.classList.add('slide', folderName); // Use the folder name as a class
                    ...
                    if (modalContent) {
                        ...
                        console.log(`Added media to ${lightboxId}: ${media.src}`);
                    } else {
                        console.error(`modal-content not found in ${lightboxId}`);
                    }
                } else {
