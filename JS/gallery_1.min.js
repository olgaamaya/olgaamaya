// // Create Programm to hide/show "social_elements2"
// //function myFunction(xyz) {
//     if (xyz.matches) {
//         // Select all elements with the class name 'classname'
//         var elements1 = document.getElementsByClassName('arrows');

//         // Loop through the elements and change their display style to 'flex'
//         for (var i = 0; i < elements1.length; i++) {
//             elements1[i].style.opacity = '0';
//             elements1[i].style.stroke = 'transparent';
//             elements1[i].style.color = 'transparent';
//         }
//     }
// };
// //
// // Create a MediaQueryList object
// var xyz = window.matchMedia("(max-width: 1050px)")

// // Call listener function at run time
// myFunction(xyz);

// // Attach listener function on state changes
// xyz.addEventListener("change", function() {
//     myFunction(xyz);
// });
...
function closeLightbox_1() {
    window.matchMedia("(min-width: 950px)").matches ?
        (document.getElementById("social_elements2").style.display = "flex") :
...
function openLightbox_22() {
    setkeys_22(),
        closeLightbox_21(),
        closeLightbox_23(),
        (document.getElementById("projecttitle_22").style.display = "block"),
        (document.getElementById("mouseTarget").style.display = "none"),
        (document.getElementById("mouseTarget").style.top = "0"),
        (document.getElementById("mouseTarget").style.zIndex = "100001"),
        (document.getElementsByTagName("body")[0].style.overflow = "hidden"),
        (document.getElementById("Lightbox_22").style.display = "flex"),
        (document.getElementById("rowid").style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
        (document.getElementsByTagName("Footer")[0].style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
...
function closeLightbox_22() {
    window.matchMedia("(min-width: 950px)").matches ?
        (document.getElementById("social_elements2").style.display = "flex") :
        (document.getElementById("social_elements2").style.display = "");

    (document.getElementById("projecttitle_22").style.display = "none"),
    (document.getElementById("mouseTarget").style.display = "flex"),
    (document.getElementById("mouseTarget").style.top = "0"),
    (document.getElementById("mouseTarget").style.zIndex = ""),
    (document.getElementsByTagName("body")[0].style.overflow = ""),
    (document.getElementById("Lightbox_22").style.display = "none"),
    (document.getElementById("rowid").style.display = "grid"),
    (document.getElementById("menu-toggle").style.display = "flex"),
    (document.getElementsByTagName("Footer")[0].style.display = "flex"),
    window.matchMedia("(max-width: 950px)").matches ?
...
function openLightbox_23() {
    setkeys_23(),
        closeLightbox_22(),
        closeLightbox_24(),
        (document.getElementById("projecttitle_23").style.display = "block"),
        (document.getElementById("mouseTarget").style.display = "none"),
        (document.getElementById("mouseTarget").style.top = "0"),
        (document.getElementById("mouseTarget").style.zIndex = "100001"),
        (document.getElementsByTagName("body")[0].style.overflow = "hidden"),
        (document.getElementById("Lightbox_23").style.display = "flex"),
        (document.getElementById("rowid").style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
        (document.getElementsByTagName("Footer")[0].style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
...
function closeLightbox_23() {
    window.matchMedia("(min-width: 950px)").matches ?
        (document.getElementById("social_elements2").style.display = "flex") :
        (document.getElementById("social_elements2").style.display = "");

    (document.getElementById("projecttitle_23").style.display = "none"),
    (document.getElementById("mouseTarget").style.display = "flex"),
    (document.getElementById("mouseTarget").style.top = "0"),
    (document.getElementById("mouseTarget").style.zIndex = ""),
    (document.getElementsByTagName("body")[0].style.overflow = ""),
    (document.getElementById("Lightbox_23").style.display = "none"),
    (document.getElementById("rowid").style.display = "grid"),
    (document.getElementById("menu-toggle").style.display = "flex"),
    (document.getElementsByTagName("Footer")[0].style.display = "flex"),
    window.matchMedia("(max-width: 950px)").matches ?
...
function openLightbox_24() {
    setkeys_24(),
        closeLightbox_1(),
        closeLightbox_23(),
        (document.getElementById("projecttitle_24").style.display = "block"),
        (document.getElementById("mouseTarget").style.display = "none"),
        (document.getElementById("mouseTarget").style.top = "0"),
        (document.getElementById("mouseTarget").style.zIndex = "100001"),
        (document.getElementsByTagName("body")[0].style.overflow = "hidden"),
        (document.getElementById("Lightbox_24").style.display = "flex"),
        (document.getElementById("rowid").style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
        (document.getElementsByTagName("Footer")[0].style.display = "none"),
        (document.getElementById("menu-toggle").style.display = "none"),
...
function closeLightbox_24() {
    window.matchMedia("(min-width: 950px)").matches ?
        (document.getElementById("social_elements2").style.display = "flex") :
        (document.getElementById("social_elements2").style.display = "");

    (document.getElementById("projecttitle_24").style.display = "none"),
    (document.getElementById("mouseTarget").style.display = "flex"),
    (document.getElementById("mouseTarget").style.top = "0"),
    (document.getElementById("mouseTarget").style.zIndex = ""),
    (document.getElementsByTagName("body")[0].style.overflow = ""),
    (document.getElementById("Lightbox_24").style.display = "none"),
    (document.getElementById("rowid").style.display = "grid"),
    (document.getElementById("menu-toggle").style.display = "flex"),
    (document.getElementsByTagName("Footer")[0].style.display = "flex"),
    window.matchMedia("(max-width: 950px)").matches ?
...
function changeSlide1(e) {
    showSlide1((slideIndex += e));
}

function setkeys_1() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide1(-1), 39 == e.keyCode && changeSlide1(1);
    };
}

function changeSlide2(e) {
    showSlide2((slideIndex += e));
}

function setkeys_2() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide2(-1), 39 == e.keyCode && changeSlide2(1);
    };
}

function changeSlide3(e) {
    pause3(), showSlide3((slideIndex += e));
}

function setkeys_3() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide3(-1), 39 == e.keyCode && changeSlide3(1);
    };
}

function changeSlide4(e) {
    pause4(), showSlide4((slideIndex += e));
}

function setkeys_4() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide4(-1), 39 == e.keyCode && changeSlide4(1);
    };
}

function changeSlide5(e) {
    showSlide5((slideIndex += e));
}

function setkeys_5() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide5(-1), 39 == e.keyCode && changeSlide5(1);
    };
}

function changeSlide6(e) {
    showSlide6((slideIndex += e));
}

function setkeys_6() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide6(-1), 39 == e.keyCode && changeSlide6(1);
    };
}

function changeSlide7(e) {
    showSlide7((slideIndex += e)), pause7();
}

function setkeys_7() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide7(-1), 39 == e.keyCode && changeSlide7(1);
    };
}

function changeSlide8(e) {
    showSlide8((slideIndex += e)), pause8();
}

function setkeys_8() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide8(-1), 39 == e.keyCode && changeSlide8(1);
    };
}

function changeSlide9(e) {
    showSlide9((slideIndex += e)), pause9();
}

function setkeys_9() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide9(-1), 39 == e.keyCode && changeSlide9(1);
    };
}

function changeSlide10(e) {
    showSlide10((slideIndex += e)), pause10();
}

function setkeys_10() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide10(-1), 39 == e.keyCode && changeSlide10(1);
    };
}

function changeSlide11(e) {
    showSlide11((slideIndex += e));
}

function setkeys_11() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide11(-1), 39 == e.keyCode && changeSlide11(1);
    };
}

function changeSlide12(e) {
    showSlide12((slideIndex += e));
}

function setkeys_12() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide12(-1), 39 == e.keyCode && changeSlide12(1);
    };
}

function changeSlide13(e) {
    showSlide13((slideIndex += e));
}

function setkeys_13() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide13(-1), 39 == e.keyCode && changeSlide13(1);
    };
}

function changeSlide14(e) {
    showSlide14((slideIndex += e));
}

function setkeys_14() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide14(-1), 39 == e.keyCode && changeSlide14(1);
    };
}

function changeSlide15(e) {
    showSlide15((slideIndex += e));
}

function setkeys_15() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide15(-1), 39 == e.keyCode && changeSlide15(1);
    };
}

function changeSlide16(e) {
    showSlide16((slideIndex += e));
}

function setkeys_16() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide16(-1), 39 == e.keyCode && changeSlide16(1);
    };
}

function changeSlide17(e) {
    showSlide17((slideIndex += e));
}

function setkeys_17() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide17(-1), 39 == e.keyCode && changeSlide17(1);
    };
}

function changeSlide18(e) {
    showSlide18((slideIndex += e));
}

function setkeys_18() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide18(-1), 39 == e.keyCode && changeSlide18(1);
    };
}

function changeSlide19(e) {
    showSlide19((slideIndex += e));
}

function setkeys_19() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide19(-1), 39 == e.keyCode && changeSlide19(1);
    };
}

function changeSlide20(e) {
    showSlide20((slideIndex += e));
}

function setkeys_20() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide20(-1), 39 == e.keyCode && changeSlide20(1);
    };
}

function changeSlide21(e) {
    showSlide21((slideIndex += e));
}

function setkeys_21() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide21(-1), 39 == e.keyCode && changeSlide21(1);
    };
}

function changeSlide22(e) {
    showSlide22((slideIndex += e));
}

function setkeys_22() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide22(-1), 39 == e.keyCode && changeSlide22(1);
    };
}

function changeSlide23(e) {
    showSlide23((slideIndex += e));
}

function setkeys_23() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide23(-1), 39 == e.keyCode && changeSlide23(1);
    };
}

function changeSlide24(e) {
    showSlide24((slideIndex += e));
}

function setkeys_24() {
    window.onkeydown = function(e) {
        37 == e.keyCode && changeSlide24(-1), 39 == e.keyCode && changeSlide24(1);
    };
}
...
function toSlide3(e) {
    showSlide3((slideIndex = e));
}

function toSlide4(e) {
    showSlide4((slideIndex = e));
}
...
function toSlide7(e) {
    showSlide7((slideIndex = e));
}

function toSlide8(e) {
    showSlide8((slideIndex = e));
}

function toSlide9(e) {
    showSlide9((slideIndex = e));
}

function toSlide10(e) {
    showSlide10((slideIndex = e));
}

function toSlide11(e) {
    showSlide11((slideIndex = e));
}

function toSlide12(e) {
    showSlide12((slideIndex = e));
}

function toSlide13(e) {
    showSlide13((slideIndex = e));
}

function toSlide14(e) {
    showSlide14((slideIndex = e));
}

function toSlide15(e) {
    showSlide15((slideIndex = e));
}

function toSlide16(e) {
    showSlide16((slideIndex = e));
}

function toSlide17(e) {
    showSlide17((slideIndex = e));
}

function toSlide18(e) {
    showSlide18((slideIndex = e));
}

function toSlide19(e) {
    showSlide19((slideIndex = e));
}

function toSlide20(e) {
    showSlide20((slideIndex = e));
}

function toSlide21(e) {
    showSlide21((slideIndex = e));
}

function toSlide22(e) {
    showSlide22((slideIndex = e));
}

function toSlide23(e) {
    showSlide23((slideIndex = e));
}

function toSlide24(e) {
    showSlide24((slideIndex = e));
}

function showSlide1(e) {
    let t = document.getElementsByClassName("slide1"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
        l[s].className = l[s].className.replace(" active", "");
    t[slideIndex - 1].style.display = "flex";
}

function showSlide2(e) {
    let t = document.getElementsByClassName("slide2"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide3(e) {
    let t = document.getElementsByClassName("slide3"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide4(e) {
    let t = document.getElementsByClassName("slide4"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide5(e) {
    let t = document.getElementsByClassName("slide5"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide6(e) {
    let t = document.getElementsByClassName("slide6"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide7(e) {
    let t = document.getElementsByClassName("slide7"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide8(e) {
    let t = document.getElementsByClassName("slide8"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide9(e) {
    let t = document.getElementsByClassName("slide9"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide10(e) {
    let t = document.getElementsByClassName("slide10"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide11(e) {
    let t = document.getElementsByClassName("slide11"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide12(e) {
    let t = document.getElementsByClassName("slide12"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide13(e) {
    let t = document.getElementsByClassName("slide13"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide14(e) {
    let t = document.getElementsByClassName("slide14"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide15(e) {
    let t = document.getElementsByClassName("slide15"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide16(e) {
    let t = document.getElementsByClassName("slide16"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide17(e) {
    let t = document.getElementsByClassName("slide17"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide18(e) {
    let t = document.getElementsByClassName("slide18"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide19(e) {
    let t = document.getElementsByClassName("slide19"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide20(e) {
    let t = document.getElementsByClassName("slide20"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide21(e) {
    let t = document.getElementsByClassName("slide21"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide22(e) {
    let t = document.getElementsByClassName("slide22"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide23(e) {
    let t = document.getElementsByClassName("slide23"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function showSlide24(e) {
    let t = document.getElementsByClassName("slide24"),
        l = document.getElementsByClassName("modal-preview");
    e > t.length && (slideIndex = 1), e < 1 && (slideIndex = t.length);
    for (let n = 0; n < t.length; n++) t[n].style.display = "none";
    for (let s = 0; s < l.length; s++)
...
function pause3() {
    let e = document.getElementById("videoId_3");
    var t = e.src;
    e.src = t;
}

function pause4() {
    let e = document.getElementById("videoId_4");
    var t = e.src;
    e.src = t;
}

function pause7() {
    let e = document.getElementById("videoId_7");
    var t = e.src;
    e.src = t;
}

function pause8() {
    let e = document.getElementById("videoId_8");
    var t = e.src;
    e.src = t;
}

function pause9() {
    let e = document.getElementById("videoId_9");
    var t = e.src;
    e.src = t;
}

function pause10() {
    let e = document.getElementById("videoId_10");
    var t = e.src;
    e.src = t;
}
