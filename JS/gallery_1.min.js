...
function displayMediaFiles(lightboxId, mediaFiles) {
...
// Function to store the last slide index in sessionStorage
function storeLastSlide(lightboxId, slideIndex) {
    sessionStorage.setItem(`lastSlideIndex_${lightboxId}`, slideIndex);
}
