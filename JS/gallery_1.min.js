            ...
            data.forEach(media => {
                ...
                if (lightbox) {
                    ...
                    if (!addedFolders[folderName]) {
                        ...
                        mediaElement.src = cloudinary.url(media.public_id, {
                            quality: 'auto',
                            secure: true // Ensure HTTPS is used
                        });
                        mediaElement.alt = media.alt;
                        mediaElement.classList.add("inj", "image-slide");

                        // Create a slide div with the correct class (slide + folder number)
                        const slide = document.createElement('div');
                        slide.classList.add('slide', `slide${folderName.replace('lightbox_', '')}`);
