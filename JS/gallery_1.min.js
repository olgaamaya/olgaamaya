...
// Function to fetch only the first image for each lightbox in one batch
function fetchMediaBatch(folderIds) {
    ...
    fetch(`https://new-vhym.onrender.com/api/get-cloudinary-media?folders=${folderIds.join(',')}`)
