...
function fetchMediaBatch(folderNames) {
    ...
    fetch(`https://new-vhym.onrender.com/api/get-cloudinary-media?folders=${folderNames.join(',')}`)
        ...
        .then(data => {
            ...
            let slideIndexes = {}; // Object to track slide index for each lightbox
            ...
            data.forEach(media => {
                ...
                if (lightbox) {
                    ...
                    if (!addedFolders[folderName]) {
                        // Initialize the slide index for this lightbox if not already done
                        if (!slideIndexes[folderName]) {
                            slideIndexes[folderName] = 1; // Set the initial slide index for this lightbox
                        }
                        ...
                        // Create a slide div and assign the correct class (slide1, slide2, etc.)
                        const slide = document.createElement('div');
                        const slideIndex = slideIndexes[folderName]; // Get the slide index for this specific lightbox
                        ...
                        // Increment the slide index for this specific lightbox
                        slideIndexes[folderName]++;
                    }
                } else {
