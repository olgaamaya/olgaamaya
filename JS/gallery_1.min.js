    ...
    fetch(`https://new-vhym.onrender.com/api/get-cloudinary-media?folder=${folderName}`)
        ...
        .then(mediaFiles => {
            ...
            if (!Array.isArray(mediaFiles) || mediaFiles.length === 0) {
                console.log(`No media found for Lightbox ${lightboxId}. Skipping media display.`);
                displayEmbeddedVideo(lightboxId); // Handle embedded video if no media is found
                return; // Exit early if no media to display
            }
