    ...
    fetch(`https://new-vhym.onrender.com/api/get-cloudinary-media?folders=${folderNames.join(',')}`)
        ...
        .then(data => {
            ...
            data.forEach(media => {
                ...
                const lightboxId = capitalizeFirstLetter(folderName); // Capitalize first letter to match HTML ID
                const lightbox = document.getElementById(lightboxId); // Select the corresponding lightbox
                ...
                if (lightbox) {
                    ...
                    slide.classList.add('slide', folderName);
